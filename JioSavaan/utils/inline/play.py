...
##bar of wynk---------------------------------------
    ...
    if 0 < anon <= 5:
        bar = "𝐒ᴏɴᴀ 𝐁𝖾𝗌𝗍 𝐅𝖾α𝗍υ𝗋𝖾𝗌"
    elif 5 <= anon < 10:
        bar = "𝐒ᴏɴᴀ 𝐅α𝗏ⱺ𝗋𝗂𝗍𝖾 ρᥣα𝗒ᥣ𝗂𝗌𝗍"
    elif 10 <= anon < 15:
        bar = "𝐒ᴏɴᴀ 𝐌𝗂ᥣᥣ𝗂ⱺ𐓣 𝐒ⱺ𐓣𝗀𝗌"
    elif 15 <= anon < 20:
        bar = "𝐒ᴏɴᴀ 𝐄α𝗌𝗂ᥣ𝗒 𝐒𝗍𝗋𝖾αꭑ"
    elif 20 <= anon < 25:
        bar = "𝐋ⱺω-𝐒ρ𝖾𝖾ᑯ 𝐒𝗍𝗋𝖾αꭑ𝗂𐓣𝗀"
    elif 25 <= anon < 30:
        bar = "𝐒ᴏɴᴀ 𝐁𝗂𝗀 𝐃α𝗍αᑲα𝗌ɦ"
    elif 30 <= anon < 35:
        ...
        bar = "𝐄𐓣𝗃ⱺ𝗒 𝐒ᴏɴᴀ 𝐎𐓣 𝐓𝖾ᥣ𝖾𝗀𝗋αꭑ"
    elif 60 <= anon < 65:
        bar = "𝐄𐓣𝗃ⱺ𝗒 𝐒ᴏɴᴀ 𝐌υ𝗌𝗂𝖼"
    elif 65 <= anon < 70:
        bar = "𝐒ᴏɴᴀ 𝑴𝒖𝒔𝒊𝒄"
    elif 70 <= anon < 75:
        bar = "𝐒ᴏɴᴀ 𝐁𝖾𝗌𝗍 𝐅𝖾α𝗍υ𝗋𝖾𝗌"
